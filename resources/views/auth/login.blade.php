...
@section('content')
    {{-- login form --}}
     <section class="flex mt-20  ml-auto mr-auto w-3/4  text-center ">
         <div class="bg-white w-6/12  h-80 rounded-tl-md rounded-bl-md">
            <div class="mt-5 pt-5"> 
                <form method="POST">
                    @csrf
                    <div>
        ...
        <div class="bg-nav-color rounded-tr-md rounded-br-md w-2/5  h-80">
            <h2 class='mt-12 text-white font-bold'>Vintage Clothing Dashboard</h2>
